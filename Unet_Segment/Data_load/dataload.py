...
from Unet_Segment import Transforms
...
class CustomData(Dataset):
    def __init__(self, file_path='Dataset/Cat&Dog/Train_set', H=600, W=480, pow_n=3, aug=True, mode='img'):
        self.H = H
        self.W = W
        self.pow_n = pow_n
        self.aug = aug
